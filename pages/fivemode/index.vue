<template>
    ...
    <div style="position: absolute;left: 0px;top:0px;z-index: 900;">
      <div style="display: grid;grid-template-columns:360px;gap: 20px;overflow-y: auto;">
         ...
         <el-button  @click="handleExportFile('Group_26')">Group_1</el-button>
      <el-button   @click="handleLoadShowMode('Group_26')">Group_1</el-button>
...
onMounted(() =>{
  ...
  //  fiveObject.handleLoadMode("/gltf/5/three.skp.gltf")
   fiveObject.handleLoadMode("/gltf/75-test/75-test.skp.gltf")
